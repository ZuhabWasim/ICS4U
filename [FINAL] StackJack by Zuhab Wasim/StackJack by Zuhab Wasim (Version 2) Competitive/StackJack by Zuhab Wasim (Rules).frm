...
Private Sub Form_Load()
    ...
    With lstRules
        ...
        .AddItem "  6. The player cannot go below zero for their score."
        .AddItem "  7. If a highscore is acheived, the player will be put on the highscore board."
        .AddItem "  8. Highscores are dependant mainly on the player's score and will use the"
        .AddItem "      player's time as a tiebreaker between two of the same scores."
        .AddItem ""
        .AddItem " Scoring-------------------------------------------------------------------------"
        ...
        .AddItem "  -If the user gets consecutive stack clears, the score given is equal to"
        .AddItem "    500 times the number of consecutive clears (n) such that (Points = 500 * n)"
    End With
...
Private Sub lstRules_GotFocus()
    ...
    'Ensures the user cannot select any item on the list box
